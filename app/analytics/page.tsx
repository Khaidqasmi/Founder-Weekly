        ...
        return (
          <div key={s.step} className="flex items-end flex-1 min-w-0">
            <div className="flex flex-col items-center w-full">
              <p className="text-base font-bold text-gray-900 dark:text-gray-100">{formatNumber(s.count)}</p>
              <p className="text-xs text-gray-400 mb-2">{s.rate}%</p>
              ...
              <p className="text-xs font-medium text-gray-600 dark:text-gray-400 mt-2 text-center leading-tight">{s.step}</p>
            </div>
    ...
    <div>
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 mb-5">
        ...
        {connected === true && (
          <button
            ...
            disabled={loading}
            className="inline-flex items-center gap-1.5 text-xs text-gray-500 hover:text-gray-700 border border-gray-200 rounded-lg px-3 py-1.5 hover:border-gray-300 transition-colors"
          >
      ...
      {loading ? <LoadingSpinner /> : (
        <>
          {/* KPI row 1 — Traffic */}
          <div className="mb-2">
            <p className="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-2">Traffic</p>
          ...
          {/* KPI row 2 — Sales */}
          <div className="mb-6">
            <p className="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-2">Sales</p>
          ...
          <div className="grid md:grid-cols-2 gap-5 mb-6">
            ...
            <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-700 p-5">
              <p className="text-sm font-semibold text-gray-700 dark:text-gray-300 mb-5">Conversion Funnel</p>
          ...
          <div className="grid md:grid-cols-2 gap-5 mb-6">
            <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-700 p-5">
              <p className="text-sm font-semibold text-gray-700 dark:text-gray-300 mb-4">Traffic Sources</p>
              <Table>
                <TableHeader>
                  <TableRow>
            ...
            <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-700 p-5">
              <p className="text-sm font-semibold text-gray-700 dark:text-gray-300 mb-4">Device Breakdown</p>
                  ...
                  <div key={d.device} className="flex items-center gap-3">
                    ...
                    <div className="flex-1">
                      <div className="flex justify-between text-sm mb-1">
                        <span className="font-medium text-gray-800 dark:text-gray-200">{d.device}</span>
                        <span className="text-gray-500">{formatNumber(d.sessions)} · {d.percentage}%</span>
                      </div>
          ...
          <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-700 p-5 mb-6">
            <p className="text-sm font-semibold text-gray-700 dark:text-gray-300 mb-4">Product Performance</p>
            <Table>
              <TableHeader>
                <TableRow>
          ...
          {data.countryBreakdown.length > 0 && (
            <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-700 p-5">
              <p className="text-sm font-semibold text-gray-700 dark:text-gray-300 mb-4">Top Countries</p>
              <Table>
                <TableHeader>
                  <TableRow>
          ...
          {connected === false && (
            <div className="mt-6 bg-white dark:bg-gray-900 rounded-xl border border-gray-200 p-8 text-center">
              ...
              <p className="text-sm text-gray-500 mt-1 mb-4">Get real sessions, bounce rate, conversion rate, traffic sources, and product performance — pulled directly from Shopify.</p>
      ...
      {connected ? (
        <div className="space-y-5">
          ...
          <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 p-8 text-center">
            ...
            <h3 className="text-base font-semibold text-gray-900 dark:text-gray-100">Google Analytics 4 Connected</h3>
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            {[
              ...
              <div key={item.title} className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 p-4">
        ...
        <div className="space-y-6">
          <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 p-8 text-center">
            ...
            <h3 className="text-base font-semibold text-gray-900 dark:text-gray-100">Connect Google Analytics 4</h3>
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950">
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="mb-6">
          ...
          <p className="text-sm text-gray-500 mt-1">Real-time store performance and website traffic data</p>
        </div>

        {/* Tab bar */}
        <div className="flex gap-1 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl p-1 mb-6 w-fit">
          <button
