...
export default function SettingsPage() {
  ...
  if (!workspace) return <div className="min-h-screen bg-[#f5f3fb]"><div className="max-w-2xl mx-auto px-4 py-8"><p>Loading...</p></div></div>

  return (
    <div className="min-h-screen bg-[#f5f3fb]">
      
      <div className="max-w-2xl mx-auto px-4 py-8">
        <h1 className="text-2xl font-bold text-[#312b63] mb-6">Settings</h1>
        <Card>
