...
export default function DemoPage() {
  ...
  return (
    <div className="min-h-screen bg-[#171233]">
      
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-8 gap-4">
          <div>
            <h1 className="text-2xl font-bold text-white">Demo Dashboard</h1>
            <p className="text-sm text-[#a79fd6] mt-1">Sample ecommerce data — this is what your dashboard will look like</p>
          </div>
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-8">
          ...
          <div className="bg-[#221c4e] rounded-lg p-4 shadow-sm">
            <SimpleBarChart data={getOrdersByDay(demoOrders)} title="Orders by Day" color="#ec4899" />
          </div>
          <div className="bg-[#221c4e] rounded-lg p-4 shadow-sm">
            <SimpleBarChart data={getAdSpendByCampaign(demoAds)} title="Ad Spend by Campaign" color="#8b5cf6" />
          </div>
          <div className="bg-[#221c4e] rounded-lg p-4 shadow-sm">
            <SimpleBarChart data={getROASByCampaign(demoAds)} title="ROAS by Campaign" color="#d946ef" />
          </div>
          <div className="bg-[#221c4e] rounded-lg p-4 shadow-sm">
            <SimpleBarChart
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-8">
          <div className="bg-[#221c4e] rounded-lg p-4 shadow-sm">
            <h3 className="text-sm font-medium text-[#c7c2e8] mb-4">Top Products</h3>
            <Table>
              <TableHeader>
                <TableRow>
          ...
          <div className="bg-[#221c4e] rounded-lg p-4 shadow-sm">
            <h3 className="text-sm font-medium text-[#c7c2e8] mb-4">Low Stock Products</h3>
            <Table>
              <TableHeader>
                <TableRow>
                  <TableHead>Product</TableHead>
        ...
        {/* Actions */}
        <div className="bg-[#221c4e] rounded-lg p-4 shadow-sm mb-8">
          <h3 className="text-sm font-medium text-[#c7c2e8] mb-4">Next 5 Actions</h3>
          <Table>
            <TableHeader>
              <TableRow>
        ...
        {/* CTA */}
        <div className="text-center py-12 bg-[#221c4e] rounded-lg shadow-sm">
          <h2 className="text-xl font-bold text-white">Like what you see?</h2>
          <p className="text-[#a79fd6] mt-2">Start your free trial and see your own business data here.</p>
          <div className="mt-6">
