  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        <h1 className="text-3xl font-bold text-center text-gray-900">Simple Pricing</h1>
        <p className="mt-4 text-center text-gray-600">Start free. Upgrade when you&apos;re ready.</p>
